...
public class ResourceInTomcatTest {
	...
	private static final String name        = "tordneba"; // just something else than abendrot to test if abendrot is hard-coded somwhere. 
	private static final String mWorkingDir = System.getProperty("java.io.tmpdir");
